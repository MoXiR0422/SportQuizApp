...
<template>
<section class="body-font relative bg-[#121527] text-gray-400">

<div class="container mx-auto px-5 py-24">
  
  <div class="mb-12 flex w-full flex-col text-center">
    <h1 class="title-font mb-4 text-2xl font-medium text-white sm:text-3xl">Biz bilan bog'lanish</h1>
  ...
  <div class="mx-auto md:w-2/3 lg:w-1/2">
    <div class="-m-2 flex flex-wrap">
      ...
      <div class="mt-8 w-full border-t border-gray-800 p-2 pt-8 text-center">
        <a class="text-indigo-400">dilshodbekphone@email.com</a>
        <p class="my-5 leading-normal">Fargona Shahar<br />Alisher Navoiy 32</p>
